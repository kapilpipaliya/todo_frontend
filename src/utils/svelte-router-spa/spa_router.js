...
export function SpaRouter(routes, currentUrl, options = {}) {
  ...
  async function findActiveRoute() {
    ...
    return await RouterFinder(routes, currentUrl, routerOptions.lang, convert).findActiveRoute();
  }
...
export async function localisedRoute(pathName, language) {
  ...
  return await SpaRouter(userDefinedRoutes, 'http://fake.com/' + pathName, routerOptions).findActiveRoute();
}
...
export async function navigateTo(pathName, language = null) {
  ...
  return await SpaRouter(userDefinedRoutes, 'http://fake.com/' + pathName, routerOptions).setActiveRoute();
}
