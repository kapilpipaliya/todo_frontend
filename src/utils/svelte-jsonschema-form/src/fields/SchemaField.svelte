<script>
  ...
  import { retrieveSchema, getUiOptions, isMultiSelect, isFilesArray } from '../util';
  ...
  function mustDisplayLabel(schema, uiSchema) {
    ...
    if (schema.type === 'array') {
      displayLabel = isMultiSelect(schema, registry.definitions) || isFilesArray(schema, uiSchema, registry.definitions);
    }
...
<Debug
  title="schemaField"
  data={{ name, formData, id, displayLabel, idSchema, props: $$props }} />
