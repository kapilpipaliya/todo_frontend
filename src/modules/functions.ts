...
import { onMount, onDestroy, createEventDispatcher, beforeUpdate, tick, setContext, getContext } from '../../svelte/src/runtime/index'
export { onMount, onDestroy, createEventDispatcher, beforeUpdate, tick, setContext, getContext } from '../../svelte/src/runtime/index'
