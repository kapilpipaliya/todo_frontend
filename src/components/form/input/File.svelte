<script lang='ts'>
    ...
    function uploadFailed(evt) {er = "Upload failed!"; } 
...
<progress bind:this={progressBar} value="0" max="100" style="width: 300px;"></progress>
<span bind:this={percentageDiv}></span><span id="time"></span>
<input 
	 {name}
	 bind:this={dom}
	 type='file'
